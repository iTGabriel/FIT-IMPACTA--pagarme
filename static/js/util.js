function check_input() {
    ...
    let input_credito_data_expiracao = document.getElementById('input_credito_data_expiracao');
    ...
    if (input_credito.value || input_credito_cvv.value || input_credito_titular.value) {
        ...
        input_credito.setAttribute('min', '16');
        
        input_credito_cvv.setAttribute('required', true);
        input_credito_cvv.setAttribute('min', '3');
        input_credito_titular.setAttribute('required', true);
        input_credito_data_expiracao.setAttribute('required', true);
    } else {
